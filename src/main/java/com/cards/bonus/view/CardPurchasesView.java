...
public class CardPurchasesView {
    private int id;
    ...
    private List<PurchasesView> purchasesView;
    ...
    public List<PurchasesView> getPurchasesView() {
        return purchasesView;
    }

    public void setPurchasesView(List<PurchasesView> purchasesView) {
